...
class JPKTFilePart(models.Model):
    _name = 'jpk.file.part'
    _description = 'JPK File Part'

    transfer_document_id = fields.Many2one('jpk.document', required=True, ondelete='cascade')
    ...
    part_number = fields.Integer(default=1, required=True)
