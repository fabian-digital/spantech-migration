...
class AccountMove(models.Model):
    ...
    auto_generated = fields.Boolean(
        help="This flag is set when this invoice is an auto_generated "
    ...
    def _inter_company_create_invoices(self):
        ...
        for rec in self:
            c1 = (
                ...
                and rec.company_id.intercompany_invoice_direction != "inbound"
            )
            c2 = (
                rec.journal_id.type == "purchase"
                and rec.company_id.intercompany_invoice_direction != "outbound"
            )
            if c1 or c2:
